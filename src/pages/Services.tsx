      ...
      <section className="py-16 bg-white ">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-deepRoyal mb-4">
            ...
            <p className="text-lg text-royal-blue-600 leading-snug max-w-3.5xl mx-auto">
              ...
              across a wide range of practice areas. Whatever your legal needs, we
              have the expertise to help you navigate complex legal matters and achieve
              favorable outcomes.
            </p>
          </div>
            ...
            {servicesData.map((service, index) => (
              <AnimatedCard key={service.id} delay={index * 0.1}>
                <div className="p-8">
                  ...
                  <h3 className="text-2xl font-serif font-bold text-deepRoyal group-hover:text-white mb-4 transition-colors">
                    {service.title}
                  </h3>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex">
                    <div className="mr-4">
                      <div className="flex items-center justify-center w-10 h-10 rounded-full bg-white text-royal-blue-900 font-bold">
                        {index + 1}
                      </div>
                    </div>
                    <div>
